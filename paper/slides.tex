...
\textbf{Alexander Assal}
\begin{itemize}\setlength{\itemsep}{0.1em}
  \item Training/eval pipelines, distillation hook, multi-scale gradient loss
  \item Sweep harness, web demo, GPU experiments, analysis
\end{itemize}

\vspace{0.5em}
\textbf{Parsa Ghasemi}
\begin{itemize}\setlength{\itemsep}{0.1em}
  \item Literature survey, dataset preparation, manifest tooling
  \item Qualitative analysis, figures, manuscript drafting
\end{itemize}

\vspace{0.5em}
Both authors jointly wrote the manuscript and prepared this presentation.
\end{frame}
